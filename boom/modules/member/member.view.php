...
class memberView extends member
{
	...
	function dispMemberInfo()
	{
		...
		if($is_biz == true) {
			$this->setTemplateFile('member_info_biz');
		} else {
	...
	function dispMemberSignUpForm()
	{
		...
		$grp = Context::get('grp');
		$certify = Context::get('certify');
		
		// Set a template file 
		if($certify == "Y") {
			if($grp == "02") {
				$this->setTemplateFile('signup_form_biz');
			} else if($grp == "01") {
				$this->setTemplateFile('signup_form');
			}
		} else if(($grp == "01" || $grp == "02") && $agree == "") {
			if($grp == "02") {
				$this->setTemplateFile('agreebiz');
			} else {
				$this->setTemplateFile('agree');
			}
			
		} else if($grp != "" && $agree == "Y") {
		 	//if($grp == "02") {
			// 	$this->setTemplateFile('certifybiz');
			//} else {
				$this->setTemplateFile('certify');
			//}
		} else {
			$this->setTemplateFile('choose');
		}		
	}
	...
	function dispMemberModifyInfo() 
	{
		...
		if($is_biz == true) {
			$this->setTemplateFile('modify_info_biz');
		} else {
