...
class documentController extends document
{
	 ...
	 * @return object
	 */
	function blindDocument($document_srl, $is_admin = false, $isEmptyTrash = false, $oDocument = null)
	{
		// Call a trigger (before)
		$trigger_obj = new stdClass();
		$trigger_obj->document_srl = $document_srl;
		...
		*/
		...
		{
			// Delete the document
			$output = executeQuery('document.blindDocument', $args);
			...
			$output = executeQuery('comment.blindComment', $args);
