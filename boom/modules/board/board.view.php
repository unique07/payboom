...
class boardView extends board
{
	...
	function _makeListColumnList()
	{
		...
		$tableColumnList = array('document_srl', 'module_srl', 'category_srl', 'lang_code', 'is_notice',
				...
				'allow_trackback', 'notify_message', 'status', 'comment_status', 'blind');
		...
		$defaultColumn = array('document_srl', 'module_srl', 'category_srl', 'lang_code', 'member_srl', 'last_update', 'comment_count', 'trackback_count', 'uploaded_count', 'status', 'regdate', 'title_bold', 'title_color', 'blind');
	...
	/**
	 * @brief display board module blind form
	 **/
	function dispBoardBlind()
	{
		// check grant
		if(!$this->grant->write_document)
		{
		 ...
		 * add JS filters
		**/
		Context::addJsFilter($this->module_path.'tpl/filter', 'blind_document.xml');
	
		$this->setTemplateFile('blind_form');
	}
	/**
