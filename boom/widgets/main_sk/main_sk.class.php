...
class main_sk extends WidgetHandler
{
    function proc($args)
    {
        ...
        $output = executeQueryArray('widgets.main_sk.getSk', $obj);
		//print_r($output);
